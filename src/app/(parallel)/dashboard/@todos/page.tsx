	...
	return slicedTodos.length ? (
		<div className="flex-col w-full col-span-3 p-4 sm:rounded-lg bg-zinc-100 dark:bg-zinc-700">
			<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
				...
				{/* <Pagination url="/dashboard/profile" totalItems={todos.length} hasShowTotal /> */}
				{/* <nav className="flex items-center justify-between px-2 pt-3 pb-2 bg-zinc-50 dark:bg-zinc-600">
					...
					<PaginationControls url="/dashboard/profile" totalItems={todos.length} />
				</nav> */}
			</div>
		</div>
	) : (
