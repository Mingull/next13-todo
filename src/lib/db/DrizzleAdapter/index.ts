...
import { SqlFlavorOptions, TableFn } from "./lib/utils";
 ...
 *
 **/
export function DrizzleAdapter<SqlFlavor extends SqlFlavorOptions>(db: SqlFlavor, table?: TableFn<SqlFlavor>): Adapter {
